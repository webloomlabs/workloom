...
CREATE UNIQUE INDEX "member_organization_user_key" ON "member" USING btree ("organization_id","user_id");--> statement-breakpoint
...
CREATE INDEX "audit_logs_organization_entity_idx" ON "audit_logs" USING btree ("organization_id","entity_type","entity_id");--> statement-breakpoint
CREATE INDEX "audit_logs_organization_actor_idx" ON "audit_logs" USING btree ("organization_id","actor_id");--> statement-breakpoint
CREATE INDEX "api_keys_organization_id_id_idx" ON "api_keys" USING btree ("organization_id","id");--> statement-breakpoint
